...
#-- GENERATED: ons 16 sep 2020 16:16:00 CEST
#-- ANTIGEN develop
_antigen () {
...
source '/home/sickan/.dotfiles/zsh/.config/zsh/.antigen/bundles/zsh-users/zsh-completions/zsh-completions.plugin.zsh';
